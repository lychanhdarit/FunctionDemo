    ...
    public class ValidateJWT
    {
        ...
        public ValidateJWT(HttpRequest request)
        {
            ...
            try
            {
                ...
                claims = new JwtBuilder().WithAlgorithm(new HMACSHA256Algorithm()).WithSecret("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").MustVerifySignature().Decode<IDictionary<string, object>>(authorizationHeader);
            }
